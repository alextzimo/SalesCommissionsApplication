...
public class ReceiptManagerXML  extends ReceiptManager{
	...
	protected void updateFile() throws IOException, Exception {
		try{
			...
			receiptElem.appendChild(companyElem);
	       	...
	       	numberElem.appendChild(doc.createTextNode(String.valueOf(receipt.getCompany().getCompanyAddress().getStreetNumber())));
